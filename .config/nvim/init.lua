...
-- NOTE: Removed default <Esc> clear search - using <leader><space> instead (see custom keymaps section)
...
-- Use semicolon as colon for commands (no need for shift)
vim.keymap.set('n', ';', ':', { desc = 'Enter command mode' })

-- Disable problematic keys
vim.keymap.set('n', 'Q', '<nop>', { desc = 'Disable Ex mode' })
vim.keymap.set('n', '<F1>', '<nop>', { desc = 'Disable help' })
vim.keymap.set('n', '<S-k>', '<nop>', { desc = 'Disable manual lookup' })

-- Save shortcuts
vim.keymap.set('n', '<C-s>', '<cmd>update<CR>', { desc = 'Save file' })
vim.keymap.set('v', '<C-s>', '<C-C><cmd>update<CR>', { desc = 'Save file' })
vim.keymap.set('i', '<C-s>', '<C-O><cmd>update<CR>', { desc = 'Save file' })
vim.keymap.set('n', '<leader>ww', '<cmd>write<CR>', { desc = '[W]rite file' })

-- Quick quit
vim.keymap.set('n', '<C-w>', '<cmd>quit!<CR>', { desc = 'Force quit' })
...
-- Clear search highlighting (changed from <leader><space> to avoid conflicts)
vim.keymap.set('n', '<leader>nh', '<cmd>nohlsearch<CR>', { desc = '[N]o [H]ighlight - clear search highlighting' })
...
-- LSP Signature Help Configuration
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Additional keybindings matching old FZF workflow
      vim.keymap.set('n', '<C-p>', builtin.find_files, { desc = 'Find Files' })
      vim.keymap.set('n', '<leader>b', builtin.buffers, { desc = '[B]uffers' })
      vim.keymap.set('n', '<leader>h', builtin.oldfiles, { desc = '[H]istory (recent files)' })
      vim.keymap.set('n', '<leader>l', builtin.current_buffer_fuzzy_find, { desc = 'Search [L]ines in current buffer' })
      vim.keymap.set('n', '<leader>g', builtin.live_grep, { desc = '[G]rep text in files' })
      vim.keymap.set('n', '<leader>rr', builtin.oldfiles, { desc = '[R]ecent files' })

      -- Search word under cursor
      vim.keymap.set('n', '<leader>ag', builtin.grep_string, { desc = 'Search word under cursor' })
    end,
  },
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Additional traditional LSP keybindings
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      -- Using tokyonight-storm for a darker theme
      -- Other options: 'tokyonight-night', 'tokyonight-moon', or 'tokyonight-day'.
