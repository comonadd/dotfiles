...
(define-key global-map (kbd "C-4") 'move-end-of-line)
(define-key global-map (kbd "C-\\") 'move-beginning-of-line)
...
(define-key global-map (kbd "C-/") 'toggle-comment-region-or-line)
;;; Editing END
...
;; File templates BEG
(define-skeleton c-file-template
  ...
  "\n"
  "}\n")
(define-auto-insert "\\.\\([Cc]\\|cc\\|cpp\\)\\'" 'c-file-template)
;; File templates END
