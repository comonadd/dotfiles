...
(custom-set-variables
 ...
 '(package-selected-packages
   '(espresso-theme clues-theme tango-plus-theme apropospriate-theme leuven-theme yaml-mode counsel all-the-icons-ivy-rich ivy-rich flycheck hl-todo string-inflection cmake-mode ag emmet-mode prettier-js php-mode glsl-mode naysayer-theme spaceline spaceline-config eltbus rust-mode treemacs-all-the-icons treemacs-projectile treemacs-evil lsp-treemacs all-the-icons zzz-to-char company-box elisp-format lsp-ivy company projectile evil-nerd-commenter bm evil-mc evil-magit magit evil-collection use-package))
